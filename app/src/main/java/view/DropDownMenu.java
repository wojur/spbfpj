...
private void addSearchImg(){
    final ImageView imgSearch = new ImageView(getContext());
    ...
    imgSearch.setImageResource(R.drawable.ic_menu_search);
    imgSearch.setOnClickListener(new OnClickListener() {
        @Override
        public void onClick(View view) {
            imgOnClickLitener.onItemClick();
        }
    });
    tabMenuView.addView(imgSearch);
